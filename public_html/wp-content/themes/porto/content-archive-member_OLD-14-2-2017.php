<?php
global $post, $porto_settings, $porto_layout, $porto_member_columns, $porto_member_view, $porto_member_overview, $porto_member_socials, $porto_member_ajax_load, $porto_member_ajax_modal, $porto_custom_zoom;
                ...
                <span class="thumb-info <?php echo $thumb_class ?>">
                    ...
                    <span class="thumb-info-wrapper <?php echo ( isset( $social_links_adv_pos) && $social_links_adv_pos ) ? 'member-social-adv-main' : '' ?>">
						...
						if(!empty($border_class)){
							$bodr_class = (count($border_class)>1)?$border_class[array_rand($border_class)]:$border_class[0];
						}
						?>
